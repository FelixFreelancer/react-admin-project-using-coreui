...
class StoreOwnerInfo extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        // axios.get(Constants.BASE_URL + '/api/store-type/store-list/:storeTypeId')
        //     .then(res => {
        //         console.log(res)
        //     })
    }
                    ...
                    <Row>
                        <Col xs="6">
                            ...
                            <Row>
                                ...
                                <Col xs="3">
                                    <Label htmlFor="dishPrice">$3500.00</Label>
                                </Col>
                            </Row>
                        </Col>
                    </Row>
