  ...
  render() {
    ...
    orders.map((row,index)=>{
      ...
      if(orderDt>=this.state.fromDt && orderDt<=this.state.toDt){
        ...
        tax+=row.taxInfo.amount?parseFloat(row.taxInfo.amount):0;
      ...
      <Card>
        ...
        <CardBody className="p-0 p-md-3">
           ...
           <Row className=" ml-2 mr-2 ml-md-4 mr-md-2">
              ...
              <Col xs="6" sm="6"  md="2" >
                <p className="text-dark h5 mt-2 text-center">$ {cod.toFixed(2)}</p>
              </Col>
           </Row>
           <Row className=" ml-2 mr-2 ml-md-4 mr-md-2">
              <Col xs="6" sm="6"  md="3" >
              ...
              <Col xs="6" sm="6"  md="2" >
                <p className="text-dark h5 mt-2 text-center">$ {paypal.toFixed(2)}</p>
              </Col>
           </Row>
           <Row className=" ml-2 mr-2 ml-md-4 mr-md-2">
              <Col xs="6" sm="6"  md="3" >
              ...
              <Col xs="6" sm="6"  md="2" >
                <p className="text-dark h5 mt-2 text-center">$ {strip.toFixed(2)}</p>
              </Col>
           </Row>
           <Row className=" ml-2 mr-2 ml-md-4 mr-md-2">
           ...
           <Row className=" ml-2 mr-2 ml-md-4 mr-md-2">
              ...
              <Col xs="6" sm="6"  md="2" >
                <p className="text-dark h5 mt-2 text-center">$ {total_subtotal.toFixed(2)}</p>
              </Col>
           </Row>
           ...
           <Row className=" ml-2 mr-2 ml-md-4 mr-md-2">
              ...
              <Col xs="6" sm="6"  md="2" >
                <p className="text-dark h5 mt-2 text-center">$ {tax.toFixed(2)}</p>
              </Col>
           </Row>
           ...
           <Row className=" ml-2 mr-2 ml-md-4 mr-md-2">
              ...
              <Col xs="6" sm="6"  md="2" >
                <p className="text-dark h5 mt-2 text-center">$ {delivery_fee!=='Free'?delivery_fee.toFixed(2):'Free'}</p>
              </Col>
           </Row>
           ...
           <Row className=" ml-2 mr-2 ml-md-4 mr-md-2">
              ...
              <Col xs="6" sm="6"  md="2" >
                <p className="text-dark h5 mt-2 text-center">$ 0.00</p>
              </Col>
           </Row>
           ...
           <Row className=" ml-2 mr-2 ml-md-4 mr-md-2">
              ...
              <Col xs="6" sm="6"  md="2" >
                <p className="text-dark h5 mt-2 text-center">$ {total_sum.toFixed(2)}</p>
              </Col>
           </Row>
